...
\begin{center}
  \begin{tabular}{ |c|c|c|c| } 
   \hline
   line no. & $\mathbb{D}$ &  $p_\mathbb{D}$ & $\softv{\ell}_\mathbb{D}$ \\
   \hline
   $1$ & $\emptyset$ & $1$ & $1$ \\ 
   $2$ & $ n_x \mapsto 0.924$ & $0.26$ & $1$ \\ 
   $3$ &  $n_x \mapsto 0.924, n_y \mapsto 0.022$ & $0.104$ & $1$ \\
   $4$ & $n_x \mapsto 0.924, n_y \mapsto 0.022$ & $0.104$ & $-900$ \\ 
   \hline
  \end{tabular}
\end{center}
...
\begin{enumerate}
  ...
  \item A control flow branch that depends on a soft Boolean takes the true side.
\end{enumerate}
