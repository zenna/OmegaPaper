...
\icmltitlerunning{Predicate Exchange: Inference with Declarative Knowledge}
% \usepackage[dvipdfm]{graphicx}
% \usepackage{bmpsize}
\begin{document}

\twocolumn[
\icmltitle{Predicate Exchange: Inference with Declarative Knowledge}
...
\icmlauthor{Javier Burroni}{amherst}
\icmlauthor{Edgar Minasyan}{princeton}
...
\icmlaffiliation{amherst}{College of Information and Computer Science, University of Massachusetts, Amherst, USA.}
