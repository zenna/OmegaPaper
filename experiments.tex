...
Table \ref{results} compares the sample expectation of particle Gibbs, sequential Monte Carlo (SMC)	, rejection Sampling (RS), and predicate exchange (PE) methods
