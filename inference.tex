...
For convenience of notation, in the context of of a random variable $\softv{Y}(\omega) = \ell((X_1(\omega), \dots, X_n(\omega)))$, we focus on $\ell$ which maps realizations of the model.
