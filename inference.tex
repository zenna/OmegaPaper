...
The \emph{intrinsic} degree of satisfaction $\soft{\lk}_{\inf}(m)$ of a realization $m = (x_1, \cdots x_n)$ of a model is then the smallest distance between that realization and any point in the constraint set, i.e.,
\begin{equation}
