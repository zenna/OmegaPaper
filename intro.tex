...
In a broader sense, conditioning revises a model such that a predicate of uncertain truth becomes a true proposition---a fact.
...
Predicates can also represent observations that are more abstract than variables in a model.
