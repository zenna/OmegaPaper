...
For a concrete implementation, we build predicate exchange into the \textsc{Omega} probabilistic programming language\footnote{\textsc{Omega} is open-source software available github.com/zenna/Omega.jl} \cite{rcd},
