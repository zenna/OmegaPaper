...
% A classical problem in Bayesian inference is conditioning to incorporate observed data into a model. 
...
\begin{enumerate}
	\item Describe conditioning of simulation based  models in measure theoretic probability as a transformation of a probability measure (Section \ref{simmodels}).
